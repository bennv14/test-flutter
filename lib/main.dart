...
//     return MaterialApp(
//       title: message?.notification?.title ?? 'Have no message',
//       theme: ThemeData(
//         colorScheme: ColorScheme.fromSeed(seedColor: Colors.deepPurple),
//         useMaterial3: true,
//       ),
//       home:
//           MyHomePage(title: message?.notification?.title ?? 'Have no message'),
//     );
//   }
// }
//
      ...
      body: SingleChildScrollView(
        ...
        child: Center(
          ...
          if (widget.didNotificationLaunchApp) ...<Widget>[
            ...
            _InfoValueString(
                title: 'Action id',
                value: widget.notificationAppLaunchDetails!.notificationResponse
                    ?.actionId),
            _InfoValueString(
                title: 'Input',
                value: widget
